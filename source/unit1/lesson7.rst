...
.. note::
    The ``0b`` prefix tells us that this is a binary representation.  Actual values come after ``0b``. 
    How many ones are in there in the binary version of ``255``?  How about ``1023``?
